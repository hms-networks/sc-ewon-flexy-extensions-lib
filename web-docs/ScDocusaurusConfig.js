...
const ScDocusaurusConfig = {
  ...
  description: 'A library of extensions to the functionality of the Ewon Flexy Java Toolkit (Ewon ETK), created by the HMS Networks, MU Americas Solution Center.',
