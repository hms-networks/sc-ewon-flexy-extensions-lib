 ...
 *       #decodeToObject(String, int, ClassLoader)} method.
...
public class Base64 {
  ...
  /**
   * A {@link InputStream} will read data from another <tt>java.io.InputStream</tt>, given in the
  ...
  /**
   * A {@link OutputStream} will write data to another <tt>java.io.OutputStream</tt>, given in the
   * constructor, and encode/decode to/from Base64 notation on the fly.
   *
   * @see Base64
   * @since 1.3
