...
public class TimeZoneManager {
  ...
  /**
   * Default interval for time zone update check. This value will provides checks on the 0, 15, 30
   * and 45 minute of every hour. These offsets are when daylight savings time changes occur.
   */
  private static final int DEFAULT_NUM_MINS_FOR_UPDATE = 15;

  /** Check for timezone updates on this interval. */
  private static int timeZoneCheckIntervalMins = DEFAULT_NUM_MINS_FOR_UPDATE;
   ...
   * injectJvmLocalTime method. This will change the JVM's default time zone.
   *
