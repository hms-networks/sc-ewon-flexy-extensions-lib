...
public class DataPointBoolean extends DataPoint {
  ...
  /**
   * Constructor for a <code>boolean</code> data point with specified quality and initialization
   * status.
   *
  ...
  /**
   * Constructor for a <code>boolean</code> data point with specified quality, but without
  ...
  /**
   * Constructor for a <code>boolean</code> data point without specified quality and without
   * initialization status.
   *
   * @param tagName data point tag name
   * @param tagId data point tag ID
