 ...
 * @version 1.0.0
 */
public abstract class SmartMqttManager {
  ...
  /**
   * Constructor for a new {@link SmartMqttManager} instance which does not wait for a WAN IP
  ...
  /**
   * Constructor for a new {@link SmartMqttManager} instance which waits for a WAN IP address to be
   * available if the specified {@code waitForWanIp} boolean is {@code true}.
   *
   * @param mqttId the ID of the MQTT client
   * @param mqttHost the host (URL) of the MQTT client connection
   * @param utf8Enable the boolean indicating if UTF-8 encoding should be used for MQTT messages
  ...
  /**
   * Constructor for a new {@link SmartMqttManager} instance which waits for a WAN IP address to be
   * available until the specified {@code wanIpTimeout} is reached. If the {@code wanIpTimeout} (in
   * the specified {@code wanIpTimeoutUnit}s) is reached before a WAN IP address is available, an
